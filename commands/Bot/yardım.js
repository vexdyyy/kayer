            ...
            .addComponents(
                new SelectMenuBuilder()
                    ...
                    .addOptions(
                        ...
                        {
                            label: 'Nsfw Menüsü',
                            description: 'Nsfw komutları ile ilgili yardım menüsünü gösterir.',
                            emoji: "📖",
                            value: 'nsfww_menu',
                        },
                    ),
            ...
            if (value[0] === "moderation_option") {
             ...
             if (value[0] === "nsfww_menu") {
                ...
                const embed = new EmbedBuilder()
                    .setColor("#5865F2")
                    .setTitle(`${client.user.username} - Yardım Menüsü!`)
                    .setDescription(`**Not:** Eğer kanalınız yaş ayarlı değilse botun komutları gorunmez`)
                    .setThumbnail(interaction2.user.displayAvatarURL({ dynamic: true }))
                    .addFields(
                        { name: '/hentai', value: 'Hentai Fotolar atar.', inline: true },
                        { name: '/nsfw', value: 'Seçmeli Nsfw Menusu.', inline: true },
                    )
                    .setFooter({ text: `${interaction2.user.tag} tarafından istendi.`, iconURL: interaction2.user.displayAvatarURL({ dynamic: true }) })
                    .setTimestamp()
